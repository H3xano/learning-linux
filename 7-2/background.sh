...
pad "${GREEN}Vous êtes prêt pour le Lab 7.2 : Le Poste de Contrôle !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh

# --- Lab 7.2 Specific File Setup ---
apt-get update >/dev/null && apt-get install -y htop iotop dnsutils traceroute >/dev/null
