...
pad "${GREEN}Vous êtes prêt pour le Lab 2.2 : La Boîte à Outils du Magicien Bash !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh

# --- Lab 2.2 Specific File Setup ---
touch /home/learner/rapport_01.txt
touch /home/learner/rapport_02.txt
touch /home/learner/photoA.jpg
touch /home/learner/photoB.jpg
touch /home/learner/image.jpeg
