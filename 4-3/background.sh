...
pad "${GREEN}Vous êtes prêt pour le Lab 4.3 : Le GPS et le Téléporteur !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh

# --- Lab 4.3 Specific File Setup ---
mkdir -p /home/learner/A/B
mkdir -p /home/learner/mon_dossier
touch /home/learner/mon_dossier/fichier_test.txt
echo '#!/bin/bash' > /home/learner/mon_script.sh
echo 'echo "Mon script a bien été exécuté !"' >> /home/learner/mon_script.sh
chmod +x /home/learner/mon_script.sh
