...
pad "${GREEN}Vous êtes prêt pour le Lab 5.4 : Les Portails Magiques de Linux !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh

# --- Lab 5.4 Specific File Setup ---
mkdir -p /home/learner/data
echo "Ceci est le fichier source." > /home/learner/data/source.txt
ln -s /un/fichier/qui/n/existe/pas /home/learner/lien_casse_initial
