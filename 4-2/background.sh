...
pad "${GREEN}Vous êtes prêt pour le Lab 4.2 : L'Inspecteur de Fichiers !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh

# --- Lab 4.2 Specific File Setup ---
echo "Ceci est un fichier texte, pas une image." > /home/learner/image_suspecte.jpg
touch /home/learner/fichier1.txt
sleep 1
touch /home/learner/fichier2.txt
mkdir -p /home/learner/un_dossier
