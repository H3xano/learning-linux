...
mkdir -p /home/learner/archives/logs

echo "confidentiel" > /home/learner/projets/secret/secret_rapport.txt
echo "Rapport final" > /home/learner/archives/RAPPORT_FINAL.PDF
echo "log d'application" > /home/learner/archives/logs/app_2023.log
echo "log système" > /home/learner/archives/logs/system_2024.log
dd if=/dev/zero of=/home/learner/gros_fichier.data bs=1k count=50
