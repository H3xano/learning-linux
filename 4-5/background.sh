...
apt-get update >/dev/null 2>&1 && apt-get install -y mlocate >/dev/null 2>&1
...
# --- Lab 4.5 Specific File Setup (CORRECTED) ---
# Create a simpler and more direct directory structure
...
# Correction: Place logs directly in 'archives'
