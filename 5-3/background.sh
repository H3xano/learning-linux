...
pad "${GREEN}Vous êtes prêt pour le Lab 5.3 : L'Espion du Système !${RESET}"; echo
EOF
chmod +x /tmp/banner.sh
# Lance un processus en arrière-plan pour que 'ps' ait quelque chose d'intéressant à trouver
(sleep infinity) &